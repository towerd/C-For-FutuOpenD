...
namespace ftq
{
	...
	public:
		...
		virtual void OnRsp_Qot_UpdateOrderDetail(const APIProtoHeader &header, const i8_t *pData, i32_t nLen) override;
		virtual void OnRsp_Qot_GetOrderDetail(const APIProtoHeader &header, const i8_t *pData, i32_t nLen) override;
