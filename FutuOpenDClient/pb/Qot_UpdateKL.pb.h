...
#ifndef PROTOBUF_Qot_5fUpdateKL_2eproto__INCLUDED
#define PROTOBUF_Qot_5fUpdateKL_2eproto__INCLUDED
...
class S2C : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_UpdateKL.S2C) */ {
 public:
  S2C();
  virtual ~S2C();
  ...
  void clear_kllist();
  static const int kKlListFieldNumber = 4;
 ...
 private:
  ...
  friend struct ::protobuf_Qot_5fUpdateKL_2eproto::TableStruct;
  friend void ::protobuf_Qot_5fUpdateKL_2eproto::InitDefaultsS2CImpl();
};
// -------------------------------------------------------------------

class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_UpdateKL.Response) */ {
 public:
  Response();
  virtual ~Response();
  ...
  const ::Qot_UpdateKL::S2C& s2c() const;
  ::Qot_UpdateKL::S2C* release_s2c();
  ::Qot_UpdateKL::S2C* mutable_s2c();
  void set_allocated_s2c(::Qot_UpdateKL::S2C* s2c);
 ...
 private:
  ...
  ::Qot_UpdateKL::S2C* s2c_;
  ::google::protobuf::int32 errcode_;
  ::google::protobuf::int32 rettype_;
  friend struct ::protobuf_Qot_5fUpdateKL_2eproto::TableStruct;
  friend void ::protobuf_Qot_5fUpdateKL_2eproto::InitDefaultsResponseImpl();
};
// ===================================================================
...
inline ::google::protobuf::int32 S2C::rehabtype() const {
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.S2C.rehabType)
  return rehabtype_;
}
inline void S2C::set_rehabtype(::google::protobuf::int32 value) {
  set_has_rehabtype();
  rehabtype_ = value;
  // @@protoc_insertion_point(field_set:Qot_UpdateKL.S2C.rehabType)
}
...
inline ::google::protobuf::int32 S2C::kltype() const {
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.S2C.klType)
  return kltype_;
}
inline void S2C::set_kltype(::google::protobuf::int32 value) {
  set_has_kltype();
  kltype_ = value;
  // @@protoc_insertion_point(field_set:Qot_UpdateKL.S2C.klType)
}
...
inline const ::Qot_Common::Security& S2C::security() const {
  ...
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.S2C.security)
...
inline ::Qot_Common::Security* S2C::release_security() {
  // @@protoc_insertion_point(field_release:Qot_UpdateKL.S2C.security)
  clear_has_security();
...
inline ::Qot_Common::Security* S2C::mutable_security() {
  ...
  // @@protoc_insertion_point(field_mutable:Qot_UpdateKL.S2C.security)
  return security_;
}
...
inline const ::Qot_Common::KLine& S2C::kllist(int index) const {
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.S2C.klList)
  return kllist_.Get(index);
}
inline ::Qot_Common::KLine* S2C::mutable_kllist(int index) {
  // @@protoc_insertion_point(field_mutable:Qot_UpdateKL.S2C.klList)
  return kllist_.Mutable(index);
}
inline ::Qot_Common::KLine* S2C::add_kllist() {
  // @@protoc_insertion_point(field_add:Qot_UpdateKL.S2C.klList)
  return kllist_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::Qot_Common::KLine >*
S2C::mutable_kllist() {
  // @@protoc_insertion_point(field_mutable_list:Qot_UpdateKL.S2C.klList)
  return &kllist_;
}
inline const ::google::protobuf::RepeatedPtrField< ::Qot_Common::KLine >&
S2C::kllist() const {
  // @@protoc_insertion_point(field_list:Qot_UpdateKL.S2C.klList)
  return kllist_;
}
...
inline ::google::protobuf::int32 Response::rettype() const {
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.Response.retType)
  return rettype_;
}
inline void Response::set_rettype(::google::protobuf::int32 value) {
  set_has_rettype();
  rettype_ = value;
  // @@protoc_insertion_point(field_set:Qot_UpdateKL.Response.retType)
}
...
inline const ::std::string& Response::retmsg() const {
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.Response.retMsg)
...
inline void Response::set_retmsg(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Qot_UpdateKL.Response.retMsg)
}
#if LANG_CXX11
inline void Response::set_retmsg(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Qot_UpdateKL.Response.retMsg)
}
#endif
inline void Response::set_retmsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Qot_UpdateKL.Response.retMsg)
}
inline void Response::set_retmsg(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Qot_UpdateKL.Response.retMsg)
}
inline ::std::string* Response::mutable_retmsg() {
  set_has_retmsg();
  // @@protoc_insertion_point(field_mutable:Qot_UpdateKL.Response.retMsg)
...
inline ::std::string* Response::release_retmsg() {
  // @@protoc_insertion_point(field_release:Qot_UpdateKL.Response.retMsg)
  clear_has_retmsg();
...
inline void Response::set_allocated_retmsg(::std::string* retmsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Qot_UpdateKL.Response.retMsg)
}
...
inline ::google::protobuf::int32 Response::errcode() const {
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.Response.errCode)
  return errcode_;
}
inline void Response::set_errcode(::google::protobuf::int32 value) {
  set_has_errcode();
  errcode_ = value;
  // @@protoc_insertion_point(field_set:Qot_UpdateKL.Response.errCode)
}
...
inline const ::Qot_UpdateKL::S2C& Response::s2c() const {
  const ::Qot_UpdateKL::S2C* p = s2c_;
  // @@protoc_insertion_point(field_get:Qot_UpdateKL.Response.s2c)
  return p != NULL ? *p : *reinterpret_cast<const ::Qot_UpdateKL::S2C*>(
      &::Qot_UpdateKL::_S2C_default_instance_);
}
inline ::Qot_UpdateKL::S2C* Response::release_s2c() {
  // @@protoc_insertion_point(field_release:Qot_UpdateKL.Response.s2c)
  clear_has_s2c();
  ::Qot_UpdateKL::S2C* temp = s2c_;
  s2c_ = NULL;
  return temp;
}
inline ::Qot_UpdateKL::S2C* Response::mutable_s2c() {
  set_has_s2c();
  if (s2c_ == NULL) {
    s2c_ = new ::Qot_UpdateKL::S2C;
  }
  // @@protoc_insertion_point(field_mutable:Qot_UpdateKL.Response.s2c)
  return s2c_;
}
inline void Response::set_allocated_s2c(::Qot_UpdateKL::S2C* s2c) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete s2c_;
  }
  ...
  s2c_ = s2c;
  // @@protoc_insertion_point(field_set_allocated:Qot_UpdateKL.Response.s2c)
}
...
#endif  // PROTOBUF_Qot_5fUpdateKL_2eproto__INCLUDED
