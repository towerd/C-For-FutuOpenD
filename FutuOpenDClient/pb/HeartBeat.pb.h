...
class C2S : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:HeartBeat.C2S) */ {
 public:
  C2S();
  virtual ~C2S();
  ...
  // @@protoc_insertion_point(class_scope:HeartBeat.C2S)
 private:
  void set_has_time();
  void clear_has_time();
  ...
  friend void ::protobuf_HeartBeat_2eproto::InitDefaultsC2SImpl();
};
// -------------------------------------------------------------------

class S2C : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:HeartBeat.S2C) */ {
 public:
  S2C();
  virtual ~S2C();
 ...
 private:
  ...
  ::google::protobuf::int64 time_;
  friend struct ::protobuf_HeartBeat_2eproto::TableStruct;
  friend void ::protobuf_HeartBeat_2eproto::InitDefaultsS2CImpl();
};
// -------------------------------------------------------------------

class Request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:HeartBeat.Request) */ {
 public:
  Request();
  virtual ~Request();
  ...
  const ::HeartBeat::C2S& c2s() const;
  ::HeartBeat::C2S* release_c2s();
  ::HeartBeat::C2S* mutable_c2s();
  void set_allocated_c2s(::HeartBeat::C2S* c2s);
 ...
 private:
  ...
  ::HeartBeat::C2S* c2s_;
  friend struct ::protobuf_HeartBeat_2eproto::TableStruct;
  friend void ::protobuf_HeartBeat_2eproto::InitDefaultsRequestImpl();
};
// -------------------------------------------------------------------

class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:HeartBeat.Response) */ {
 public:
  Response();
  virtual ~Response();
  ...
  const ::HeartBeat::S2C& s2c() const;
  ::HeartBeat::S2C* release_s2c();
  ::HeartBeat::S2C* mutable_s2c();
  void set_allocated_s2c(::HeartBeat::S2C* s2c);
 ...
 private:
  ...
  friend struct ::protobuf_HeartBeat_2eproto::TableStruct;
  friend void ::protobuf_HeartBeat_2eproto::InitDefaultsResponseImpl();
};
// ===================================================================
...
inline ::google::protobuf::int64 C2S::time() const {
  // @@protoc_insertion_point(field_get:HeartBeat.C2S.time)
  return time_;
}
inline void C2S::set_time(::google::protobuf::int64 value) {
  set_has_time();
  time_ = value;
  // @@protoc_insertion_point(field_set:HeartBeat.C2S.time)
}
...
inline ::google::protobuf::int64 S2C::time() const {
  // @@protoc_insertion_point(field_get:HeartBeat.S2C.time)
  return time_;
}
inline void S2C::set_time(::google::protobuf::int64 value) {
  set_has_time();
  time_ = value;
  // @@protoc_insertion_point(field_set:HeartBeat.S2C.time)
}
...
inline const ::HeartBeat::C2S& Request::c2s() const {
  const ::HeartBeat::C2S* p = c2s_;
  // @@protoc_insertion_point(field_get:HeartBeat.Request.c2s)
  return p != NULL ? *p : *reinterpret_cast<const ::HeartBeat::C2S*>(
      &::HeartBeat::_C2S_default_instance_);
}
inline ::HeartBeat::C2S* Request::release_c2s() {
  // @@protoc_insertion_point(field_release:HeartBeat.Request.c2s)
  clear_has_c2s();
  ::HeartBeat::C2S* temp = c2s_;
  c2s_ = NULL;
  return temp;
}
inline ::HeartBeat::C2S* Request::mutable_c2s() {
  set_has_c2s();
  if (c2s_ == NULL) {
    c2s_ = new ::HeartBeat::C2S;
  }
  // @@protoc_insertion_point(field_mutable:HeartBeat.Request.c2s)
  return c2s_;
}
inline void Request::set_allocated_c2s(::HeartBeat::C2S* c2s) {
  ...
  c2s_ = c2s;
  // @@protoc_insertion_point(field_set_allocated:HeartBeat.Request.c2s)
}
...
inline ::google::protobuf::int32 Response::rettype() const {
  // @@protoc_insertion_point(field_get:HeartBeat.Response.retType)
  return rettype_;
}
inline void Response::set_rettype(::google::protobuf::int32 value) {
  set_has_rettype();
  rettype_ = value;
  // @@protoc_insertion_point(field_set:HeartBeat.Response.retType)
}
...
inline const ::std::string& Response::retmsg() const {
  // @@protoc_insertion_point(field_get:HeartBeat.Response.retMsg)
...
inline void Response::set_retmsg(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:HeartBeat.Response.retMsg)
}
#if LANG_CXX11
inline void Response::set_retmsg(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:HeartBeat.Response.retMsg)
}
#endif
inline void Response::set_retmsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:HeartBeat.Response.retMsg)
}
inline void Response::set_retmsg(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:HeartBeat.Response.retMsg)
}
inline ::std::string* Response::mutable_retmsg() {
  set_has_retmsg();
  // @@protoc_insertion_point(field_mutable:HeartBeat.Response.retMsg)
...
inline ::std::string* Response::release_retmsg() {
  // @@protoc_insertion_point(field_release:HeartBeat.Response.retMsg)
  clear_has_retmsg();
...
inline void Response::set_allocated_retmsg(::std::string* retmsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:HeartBeat.Response.retMsg)
}
...
inline ::google::protobuf::int32 Response::errcode() const {
  // @@protoc_insertion_point(field_get:HeartBeat.Response.errCode)
  return errcode_;
}
inline void Response::set_errcode(::google::protobuf::int32 value) {
  set_has_errcode();
  errcode_ = value;
  // @@protoc_insertion_point(field_set:HeartBeat.Response.errCode)
}
...
inline const ::HeartBeat::S2C& Response::s2c() const {
  const ::HeartBeat::S2C* p = s2c_;
  // @@protoc_insertion_point(field_get:HeartBeat.Response.s2c)
  return p != NULL ? *p : *reinterpret_cast<const ::HeartBeat::S2C*>(
      &::HeartBeat::_S2C_default_instance_);
}
inline ::HeartBeat::S2C* Response::release_s2c() {
  // @@protoc_insertion_point(field_release:HeartBeat.Response.s2c)
  clear_has_s2c();
  ::HeartBeat::S2C* temp = s2c_;
  s2c_ = NULL;
  return temp;
}
inline ::HeartBeat::S2C* Response::mutable_s2c() {
  set_has_s2c();
  if (s2c_ == NULL) {
    s2c_ = new ::HeartBeat::S2C;
  }
  // @@protoc_insertion_point(field_mutable:HeartBeat.Response.s2c)
  return s2c_;
}
inline void Response::set_allocated_s2c(::HeartBeat::S2C* s2c) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete s2c_;
  }
  ...
  s2c_ = s2c;
  // @@protoc_insertion_point(field_set_allocated:HeartBeat.Response.s2c)
}
