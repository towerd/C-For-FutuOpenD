...
#ifndef PROTOBUF_Trd_5fGetOrderList_2eproto__INCLUDED
#define PROTOBUF_Trd_5fGetOrderList_2eproto__INCLUDED
...
class C2S : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Trd_GetOrderList.C2S) */ {
 public:
  C2S();
  virtual ~C2S();
 ...
 private:
  ...
  friend struct ::protobuf_Trd_5fGetOrderList_2eproto::TableStruct;
  friend void ::protobuf_Trd_5fGetOrderList_2eproto::InitDefaultsC2SImpl();
};
// -------------------------------------------------------------------

class S2C : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Trd_GetOrderList.S2C) */ {
 public:
  S2C();
  virtual ~S2C();
 ...
 private:
  ...
  ::Trd_Common::TrdHeader* header_;
  friend struct ::protobuf_Trd_5fGetOrderList_2eproto::TableStruct;
  friend void ::protobuf_Trd_5fGetOrderList_2eproto::InitDefaultsS2CImpl();
};
// -------------------------------------------------------------------

class Request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Trd_GetOrderList.Request) */ {
 public:
  Request();
  virtual ~Request();
  ...
  const ::Trd_GetOrderList::C2S& c2s() const;
  ::Trd_GetOrderList::C2S* release_c2s();
  ::Trd_GetOrderList::C2S* mutable_c2s();
  void set_allocated_c2s(::Trd_GetOrderList::C2S* c2s);
 ...
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::Trd_GetOrderList::C2S* c2s_;
  friend struct ::protobuf_Trd_5fGetOrderList_2eproto::TableStruct;
  friend void ::protobuf_Trd_5fGetOrderList_2eproto::InitDefaultsRequestImpl();
};
// -------------------------------------------------------------------

class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Trd_GetOrderList.Response) */ {
 public:
  Response();
  virtual ~Response();
  ...
  const ::Trd_GetOrderList::S2C& s2c() const;
  ::Trd_GetOrderList::S2C* release_s2c();
  ::Trd_GetOrderList::S2C* mutable_s2c();
  void set_allocated_s2c(::Trd_GetOrderList::S2C* s2c);
 ...
 private:
  ...
  ::Trd_GetOrderList::S2C* s2c_;
  ::google::protobuf::int32 errcode_;
  ::google::protobuf::int32 rettype_;
  friend struct ::protobuf_Trd_5fGetOrderList_2eproto::TableStruct;
  friend void ::protobuf_Trd_5fGetOrderList_2eproto::InitDefaultsResponseImpl();
};
// ===================================================================
...
inline const ::Trd_Common::TrdHeader& C2S::header() const {
  ...
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.C2S.header)
...
inline ::Trd_Common::TrdHeader* C2S::release_header() {
  // @@protoc_insertion_point(field_release:Trd_GetOrderList.C2S.header)
  clear_has_header();
...
inline ::Trd_Common::TrdHeader* C2S::mutable_header() {
  ...
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.C2S.header)
  return header_;
}
inline void C2S::set_allocated_header(::Trd_Common::TrdHeader* header) {
  ...
  header_ = header;
  // @@protoc_insertion_point(field_set_allocated:Trd_GetOrderList.C2S.header)
}
...
inline const ::Trd_Common::TrdFilterConditions& C2S::filterconditions() const {
  ...
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.C2S.filterConditions)
...
inline ::Trd_Common::TrdFilterConditions* C2S::release_filterconditions() {
  // @@protoc_insertion_point(field_release:Trd_GetOrderList.C2S.filterConditions)
...
inline ::Trd_Common::TrdFilterConditions* C2S::mutable_filterconditions() {
  ...
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.C2S.filterConditions)
...
inline void C2S::set_allocated_filterconditions(::Trd_Common::TrdFilterConditions* filterconditions) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Trd_GetOrderList.C2S.filterConditions)
}
...
inline ::google::protobuf::int32 C2S::filterstatuslist(int index) const {
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.C2S.filterStatusList)
...
inline void C2S::set_filterstatuslist(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:Trd_GetOrderList.C2S.filterStatusList)
}
inline void C2S::add_filterstatuslist(::google::protobuf::int32 value) {
  filterstatuslist_.Add(value);
  // @@protoc_insertion_point(field_add:Trd_GetOrderList.C2S.filterStatusList)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
C2S::filterstatuslist() const {
  // @@protoc_insertion_point(field_list:Trd_GetOrderList.C2S.filterStatusList)
  return filterstatuslist_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
C2S::mutable_filterstatuslist() {
  // @@protoc_insertion_point(field_mutable_list:Trd_GetOrderList.C2S.filterStatusList)
  return &filterstatuslist_;
}
...
inline const ::Trd_Common::TrdHeader& S2C::header() const {
  const ::Trd_Common::TrdHeader* p = header_;
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.S2C.header)
  return p != NULL ? *p : *reinterpret_cast<const ::Trd_Common::TrdHeader*>(
      &::Trd_Common::_TrdHeader_default_instance_);
}
inline ::Trd_Common::TrdHeader* S2C::release_header() {
  // @@protoc_insertion_point(field_release:Trd_GetOrderList.S2C.header)
  clear_has_header();
  ::Trd_Common::TrdHeader* temp = header_;
  header_ = NULL;
  return temp;
...
inline ::Trd_Common::TrdHeader* S2C::mutable_header() {
  ...
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.S2C.header)
  return header_;
}
inline void S2C::set_allocated_header(::Trd_Common::TrdHeader* header) {
  ...
  header_ = header;
  // @@protoc_insertion_point(field_set_allocated:Trd_GetOrderList.S2C.header)
}
...
inline const ::Trd_Common::Order& S2C::orderlist(int index) const {
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.S2C.orderList)
  return orderlist_.Get(index);
}
inline ::Trd_Common::Order* S2C::mutable_orderlist(int index) {
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.S2C.orderList)
  return orderlist_.Mutable(index);
}
inline ::Trd_Common::Order* S2C::add_orderlist() {
  // @@protoc_insertion_point(field_add:Trd_GetOrderList.S2C.orderList)
  return orderlist_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::Trd_Common::Order >*
S2C::mutable_orderlist() {
  // @@protoc_insertion_point(field_mutable_list:Trd_GetOrderList.S2C.orderList)
  return &orderlist_;
}
inline const ::google::protobuf::RepeatedPtrField< ::Trd_Common::Order >&
S2C::orderlist() const {
  // @@protoc_insertion_point(field_list:Trd_GetOrderList.S2C.orderList)
  return orderlist_;
}
...
inline const ::Trd_GetOrderList::C2S& Request::c2s() const {
  const ::Trd_GetOrderList::C2S* p = c2s_;
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.Request.c2s)
  return p != NULL ? *p : *reinterpret_cast<const ::Trd_GetOrderList::C2S*>(
      &::Trd_GetOrderList::_C2S_default_instance_);
}
inline ::Trd_GetOrderList::C2S* Request::release_c2s() {
  // @@protoc_insertion_point(field_release:Trd_GetOrderList.Request.c2s)
  clear_has_c2s();
  ::Trd_GetOrderList::C2S* temp = c2s_;
  c2s_ = NULL;
  return temp;
}
inline ::Trd_GetOrderList::C2S* Request::mutable_c2s() {
  set_has_c2s();
  if (c2s_ == NULL) {
    c2s_ = new ::Trd_GetOrderList::C2S;
  }
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.Request.c2s)
  return c2s_;
}
inline void Request::set_allocated_c2s(::Trd_GetOrderList::C2S* c2s) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete c2s_;
  }
  ...
  c2s_ = c2s;
  // @@protoc_insertion_point(field_set_allocated:Trd_GetOrderList.Request.c2s)
}
...
inline ::google::protobuf::int32 Response::rettype() const {
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.Response.retType)
  return rettype_;
}
inline void Response::set_rettype(::google::protobuf::int32 value) {
  set_has_rettype();
  rettype_ = value;
  // @@protoc_insertion_point(field_set:Trd_GetOrderList.Response.retType)
}
...
inline const ::std::string& Response::retmsg() const {
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.Response.retMsg)
...
inline void Response::set_retmsg(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Trd_GetOrderList.Response.retMsg)
}
#if LANG_CXX11
inline void Response::set_retmsg(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Trd_GetOrderList.Response.retMsg)
}
#endif
inline void Response::set_retmsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Trd_GetOrderList.Response.retMsg)
}
inline void Response::set_retmsg(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Trd_GetOrderList.Response.retMsg)
}
inline ::std::string* Response::mutable_retmsg() {
  set_has_retmsg();
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.Response.retMsg)
...
inline ::std::string* Response::release_retmsg() {
  // @@protoc_insertion_point(field_release:Trd_GetOrderList.Response.retMsg)
  clear_has_retmsg();
...
inline void Response::set_allocated_retmsg(::std::string* retmsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Trd_GetOrderList.Response.retMsg)
}
...
inline ::google::protobuf::int32 Response::errcode() const {
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.Response.errCode)
  return errcode_;
}
inline void Response::set_errcode(::google::protobuf::int32 value) {
  set_has_errcode();
  errcode_ = value;
  // @@protoc_insertion_point(field_set:Trd_GetOrderList.Response.errCode)
}
...
inline const ::Trd_GetOrderList::S2C& Response::s2c() const {
  const ::Trd_GetOrderList::S2C* p = s2c_;
  // @@protoc_insertion_point(field_get:Trd_GetOrderList.Response.s2c)
  return p != NULL ? *p : *reinterpret_cast<const ::Trd_GetOrderList::S2C*>(
      &::Trd_GetOrderList::_S2C_default_instance_);
}
inline ::Trd_GetOrderList::S2C* Response::release_s2c() {
  // @@protoc_insertion_point(field_release:Trd_GetOrderList.Response.s2c)
  clear_has_s2c();
  ::Trd_GetOrderList::S2C* temp = s2c_;
  s2c_ = NULL;
  return temp;
}
inline ::Trd_GetOrderList::S2C* Response::mutable_s2c() {
  set_has_s2c();
  if (s2c_ == NULL) {
    s2c_ = new ::Trd_GetOrderList::S2C;
  }
  // @@protoc_insertion_point(field_mutable:Trd_GetOrderList.Response.s2c)
  return s2c_;
}
inline void Response::set_allocated_s2c(::Trd_GetOrderList::S2C* s2c) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete s2c_;
  }
  ...
  s2c_ = s2c;
  // @@protoc_insertion_point(field_set_allocated:Trd_GetOrderList.Response.s2c)
}
...
#endif  // PROTOBUF_Trd_5fGetOrderList_2eproto__INCLUDED
