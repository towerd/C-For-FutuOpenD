...
#ifndef PROTOBUF_Qot_5fGetRT_2eproto__INCLUDED
#define PROTOBUF_Qot_5fGetRT_2eproto__INCLUDED
...
class C2S : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_GetRT.C2S) */ {
 public:
  C2S();
  virtual ~C2S();
 ...
 private:
  ...
  friend void ::protobuf_Qot_5fGetRT_2eproto::InitDefaultsC2SImpl();
};
// -------------------------------------------------------------------

class S2C : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_GetRT.S2C) */ {
 public:
  S2C();
  virtual ~S2C();
...
class Request : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_GetRT.Request) */ {
 public:
  Request();
  virtual ~Request();
  ...
  const ::Qot_GetRT::C2S& c2s() const;
  ::Qot_GetRT::C2S* release_c2s();
  ::Qot_GetRT::C2S* mutable_c2s();
  void set_allocated_c2s(::Qot_GetRT::C2S* c2s);
 ...
 private:
  ...
  ::Qot_GetRT::C2S* c2s_;
  friend struct ::protobuf_Qot_5fGetRT_2eproto::TableStruct;
  friend void ::protobuf_Qot_5fGetRT_2eproto::InitDefaultsRequestImpl();
};
// -------------------------------------------------------------------

class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Qot_GetRT.Response) */ {
 public:
  Response();
  virtual ~Response();
  ...
  const ::Qot_GetRT::S2C& s2c() const;
  ::Qot_GetRT::S2C* release_s2c();
  ::Qot_GetRT::S2C* mutable_s2c();
  void set_allocated_s2c(::Qot_GetRT::S2C* s2c);
 ...
 private:
  ...
  friend struct ::protobuf_Qot_5fGetRT_2eproto::TableStruct;
  friend void ::protobuf_Qot_5fGetRT_2eproto::InitDefaultsResponseImpl();
};
// ===================================================================
...
inline const ::Qot_Common::Security& C2S::security() const {
  ...
  // @@protoc_insertion_point(field_get:Qot_GetRT.C2S.security)
...
inline ::Qot_Common::Security* C2S::release_security() {
  // @@protoc_insertion_point(field_release:Qot_GetRT.C2S.security)
  clear_has_security();
...
inline ::Qot_Common::Security* C2S::mutable_security() {
  ...
  // @@protoc_insertion_point(field_mutable:Qot_GetRT.C2S.security)
  return security_;
}
inline void C2S::set_allocated_security(::Qot_Common::Security* security) {
  ...
  security_ = security;
  // @@protoc_insertion_point(field_set_allocated:Qot_GetRT.C2S.security)
}
...
inline const ::Qot_Common::Security& S2C::security() const {
  const ::Qot_Common::Security* p = security_;
  // @@protoc_insertion_point(field_get:Qot_GetRT.S2C.security)
  return p != NULL ? *p : *reinterpret_cast<const ::Qot_Common::Security*>(
      &::Qot_Common::_Security_default_instance_);
}
inline ::Qot_Common::Security* S2C::release_security() {
  // @@protoc_insertion_point(field_release:Qot_GetRT.S2C.security)
  clear_has_security();
  ::Qot_Common::Security* temp = security_;
  security_ = NULL;
  return temp;
...
inline ::Qot_Common::Security* S2C::mutable_security() {
  ...
  // @@protoc_insertion_point(field_mutable:Qot_GetRT.S2C.security)
  return security_;
}
...
inline const ::Qot_Common::TimeShare& S2C::rtlist(int index) const {
  // @@protoc_insertion_point(field_get:Qot_GetRT.S2C.rtList)
  return rtlist_.Get(index);
}
inline ::Qot_Common::TimeShare* S2C::mutable_rtlist(int index) {
  // @@protoc_insertion_point(field_mutable:Qot_GetRT.S2C.rtList)
  return rtlist_.Mutable(index);
}
inline ::Qot_Common::TimeShare* S2C::add_rtlist() {
  // @@protoc_insertion_point(field_add:Qot_GetRT.S2C.rtList)
  return rtlist_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::Qot_Common::TimeShare >*
S2C::mutable_rtlist() {
  // @@protoc_insertion_point(field_mutable_list:Qot_GetRT.S2C.rtList)
  return &rtlist_;
}
inline const ::google::protobuf::RepeatedPtrField< ::Qot_Common::TimeShare >&
S2C::rtlist() const {
  // @@protoc_insertion_point(field_list:Qot_GetRT.S2C.rtList)
  return rtlist_;
}
...
inline const ::Qot_GetRT::C2S& Request::c2s() const {
  const ::Qot_GetRT::C2S* p = c2s_;
  // @@protoc_insertion_point(field_get:Qot_GetRT.Request.c2s)
  return p != NULL ? *p : *reinterpret_cast<const ::Qot_GetRT::C2S*>(
      &::Qot_GetRT::_C2S_default_instance_);
}
inline ::Qot_GetRT::C2S* Request::release_c2s() {
  // @@protoc_insertion_point(field_release:Qot_GetRT.Request.c2s)
  clear_has_c2s();
  ::Qot_GetRT::C2S* temp = c2s_;
  c2s_ = NULL;
  return temp;
}
inline ::Qot_GetRT::C2S* Request::mutable_c2s() {
  set_has_c2s();
  if (c2s_ == NULL) {
    c2s_ = new ::Qot_GetRT::C2S;
  }
  // @@protoc_insertion_point(field_mutable:Qot_GetRT.Request.c2s)
  return c2s_;
}
inline void Request::set_allocated_c2s(::Qot_GetRT::C2S* c2s) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete c2s_;
  }
  ...
  c2s_ = c2s;
  // @@protoc_insertion_point(field_set_allocated:Qot_GetRT.Request.c2s)
}
...
inline ::google::protobuf::int32 Response::rettype() const {
  // @@protoc_insertion_point(field_get:Qot_GetRT.Response.retType)
  return rettype_;
}
inline void Response::set_rettype(::google::protobuf::int32 value) {
  set_has_rettype();
  rettype_ = value;
  // @@protoc_insertion_point(field_set:Qot_GetRT.Response.retType)
}
...
inline const ::std::string& Response::retmsg() const {
  // @@protoc_insertion_point(field_get:Qot_GetRT.Response.retMsg)
...
inline void Response::set_retmsg(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Qot_GetRT.Response.retMsg)
}
#if LANG_CXX11
inline void Response::set_retmsg(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Qot_GetRT.Response.retMsg)
}
#endif
inline void Response::set_retmsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Qot_GetRT.Response.retMsg)
}
inline void Response::set_retmsg(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Qot_GetRT.Response.retMsg)
}
inline ::std::string* Response::mutable_retmsg() {
  set_has_retmsg();
  // @@protoc_insertion_point(field_mutable:Qot_GetRT.Response.retMsg)
...
inline ::std::string* Response::release_retmsg() {
  // @@protoc_insertion_point(field_release:Qot_GetRT.Response.retMsg)
  clear_has_retmsg();
...
inline void Response::set_allocated_retmsg(::std::string* retmsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Qot_GetRT.Response.retMsg)
}
...
inline ::google::protobuf::int32 Response::errcode() const {
  // @@protoc_insertion_point(field_get:Qot_GetRT.Response.errCode)
  return errcode_;
}
inline void Response::set_errcode(::google::protobuf::int32 value) {
  set_has_errcode();
  errcode_ = value;
  // @@protoc_insertion_point(field_set:Qot_GetRT.Response.errCode)
}
...
inline const ::Qot_GetRT::S2C& Response::s2c() const {
  const ::Qot_GetRT::S2C* p = s2c_;
  // @@protoc_insertion_point(field_get:Qot_GetRT.Response.s2c)
  return p != NULL ? *p : *reinterpret_cast<const ::Qot_GetRT::S2C*>(
      &::Qot_GetRT::_S2C_default_instance_);
}
inline ::Qot_GetRT::S2C* Response::release_s2c() {
  // @@protoc_insertion_point(field_release:Qot_GetRT.Response.s2c)
  clear_has_s2c();
  ::Qot_GetRT::S2C* temp = s2c_;
  s2c_ = NULL;
  return temp;
}
inline ::Qot_GetRT::S2C* Response::mutable_s2c() {
  set_has_s2c();
  if (s2c_ == NULL) {
    s2c_ = new ::Qot_GetRT::S2C;
  }
  // @@protoc_insertion_point(field_mutable:Qot_GetRT.Response.s2c)
  return s2c_;
}
inline void Response::set_allocated_s2c(::Qot_GetRT::S2C* s2c) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete s2c_;
  }
  ...
  s2c_ = s2c;
  // @@protoc_insertion_point(field_set_allocated:Qot_GetRT.Response.s2c)
}
...
#endif  // PROTOBUF_Qot_5fGetRT_2eproto__INCLUDED
