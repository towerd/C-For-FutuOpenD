...
#ifndef PROTOBUF_Trd_5fNotify_2eproto__INCLUDED
#define PROTOBUF_Trd_5fNotify_2eproto__INCLUDED
...
class S2C : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Trd_Notify.S2C) */ {
 public:
  S2C();
  virtual ~S2C();
 ...
 private:
  ...
  friend struct ::protobuf_Trd_5fNotify_2eproto::TableStruct;
  friend void ::protobuf_Trd_5fNotify_2eproto::InitDefaultsS2CImpl();
};
// -------------------------------------------------------------------

class Response : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Trd_Notify.Response) */ {
 public:
  Response();
  virtual ~Response();
  ...
  const ::Trd_Notify::S2C& s2c() const;
  ::Trd_Notify::S2C* release_s2c();
  ::Trd_Notify::S2C* mutable_s2c();
  void set_allocated_s2c(::Trd_Notify::S2C* s2c);
 ...
 private:
  ...
  friend struct ::protobuf_Trd_5fNotify_2eproto::TableStruct;
  friend void ::protobuf_Trd_5fNotify_2eproto::InitDefaultsResponseImpl();
};
// ===================================================================
...
inline const ::Trd_Common::TrdHeader& S2C::header() const {
  ...
  // @@protoc_insertion_point(field_get:Trd_Notify.S2C.header)
...
inline ::Trd_Common::TrdHeader* S2C::release_header() {
  // @@protoc_insertion_point(field_release:Trd_Notify.S2C.header)
  clear_has_header();
...
inline ::Trd_Common::TrdHeader* S2C::mutable_header() {
  ...
  // @@protoc_insertion_point(field_mutable:Trd_Notify.S2C.header)
  return header_;
}
inline void S2C::set_allocated_header(::Trd_Common::TrdHeader* header) {
  ...
  header_ = header;
  // @@protoc_insertion_point(field_set_allocated:Trd_Notify.S2C.header)
}
...
inline ::google::protobuf::int32 S2C::type() const {
  // @@protoc_insertion_point(field_get:Trd_Notify.S2C.type)
  return type_;
}
inline void S2C::set_type(::google::protobuf::int32 value) {
  set_has_type();
  type_ = value;
  // @@protoc_insertion_point(field_set:Trd_Notify.S2C.type)
}
...
inline ::google::protobuf::int32 Response::rettype() const {
  // @@protoc_insertion_point(field_get:Trd_Notify.Response.retType)
  return rettype_;
}
inline void Response::set_rettype(::google::protobuf::int32 value) {
  set_has_rettype();
  rettype_ = value;
  // @@protoc_insertion_point(field_set:Trd_Notify.Response.retType)
}
...
inline const ::std::string& Response::retmsg() const {
  // @@protoc_insertion_point(field_get:Trd_Notify.Response.retMsg)
...
inline void Response::set_retmsg(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Trd_Notify.Response.retMsg)
}
#if LANG_CXX11
inline void Response::set_retmsg(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:Trd_Notify.Response.retMsg)
}
#endif
inline void Response::set_retmsg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:Trd_Notify.Response.retMsg)
}
inline void Response::set_retmsg(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Trd_Notify.Response.retMsg)
}
inline ::std::string* Response::mutable_retmsg() {
  set_has_retmsg();
  // @@protoc_insertion_point(field_mutable:Trd_Notify.Response.retMsg)
...
inline ::std::string* Response::release_retmsg() {
  // @@protoc_insertion_point(field_release:Trd_Notify.Response.retMsg)
  clear_has_retmsg();
...
inline void Response::set_allocated_retmsg(::std::string* retmsg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Trd_Notify.Response.retMsg)
}
...
inline ::google::protobuf::int32 Response::errcode() const {
  // @@protoc_insertion_point(field_get:Trd_Notify.Response.errCode)
  return errcode_;
}
inline void Response::set_errcode(::google::protobuf::int32 value) {
  set_has_errcode();
  errcode_ = value;
  // @@protoc_insertion_point(field_set:Trd_Notify.Response.errCode)
}
...
inline const ::Trd_Notify::S2C& Response::s2c() const {
  const ::Trd_Notify::S2C* p = s2c_;
  // @@protoc_insertion_point(field_get:Trd_Notify.Response.s2c)
  return p != NULL ? *p : *reinterpret_cast<const ::Trd_Notify::S2C*>(
      &::Trd_Notify::_S2C_default_instance_);
}
inline ::Trd_Notify::S2C* Response::release_s2c() {
  // @@protoc_insertion_point(field_release:Trd_Notify.Response.s2c)
  clear_has_s2c();
  ::Trd_Notify::S2C* temp = s2c_;
  s2c_ = NULL;
  return temp;
}
inline ::Trd_Notify::S2C* Response::mutable_s2c() {
  set_has_s2c();
  if (s2c_ == NULL) {
    s2c_ = new ::Trd_Notify::S2C;
  }
  // @@protoc_insertion_point(field_mutable:Trd_Notify.Response.s2c)
  return s2c_;
}
inline void Response::set_allocated_s2c(::Trd_Notify::S2C* s2c) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete s2c_;
  }
  ...
  s2c_ = s2c;
  // @@protoc_insertion_point(field_set_allocated:Trd_Notify.Response.s2c)
}
...
#endif  // PROTOBUF_Trd_5fNotify_2eproto__INCLUDED
